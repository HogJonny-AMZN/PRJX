...
IF "%HOG_PY_BASE_SYS_PATH_ENV%"=="1" GOTO :END_OF_FILE
...
SET "PATH=%HOG_PYTHONTOOLS_PATH%;%HOG_PYTHONTOOLS_PATH%\scripts;%HOG_PY_BASE_INSTALL%;%HOG_PY_BASE_INSTALL%\scripts;%PATH%"
...
IF "%HOG_PY_DEBUG_VERBOSE%"=="1" (
   echo Initializing::  %~dp0set_hog_base_python_PATH.cmd
...
SET "HOG_PY_BASE_SYS_PATH_ENV=1"
